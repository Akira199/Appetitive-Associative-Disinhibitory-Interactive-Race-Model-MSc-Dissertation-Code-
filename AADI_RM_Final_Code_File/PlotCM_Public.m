...
plot([SSDall(ssd)+SSRT_by_SSD(ssd) SSDall(ssd)+SSRT_by_SSD(ssd)],[0 1050], 'r')  % plot SSRT
plot([0 length(ActFunc(ssd).Can)],[1000 1000], 'k')  % plot threshold
legend('GOunit_s_i_g_I_n_h_i_b', 'GOunit_l_a_t_M_a_t_c_h_N_S_S', 'STOPunit', 'SSRT', 'location', 'EastOutside')
ylim([0 1050])
xlim([0 400])
