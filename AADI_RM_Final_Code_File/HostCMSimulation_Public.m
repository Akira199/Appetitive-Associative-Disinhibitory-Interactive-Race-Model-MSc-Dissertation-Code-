function [NSS_rtSim, inhib_funcSim, SS_rtSim, predSSRT, ActFunc] = ...
    HostCMSimulation_Public(param, SSDall, NUMB_TR, cueType, master_seed, iteration);
