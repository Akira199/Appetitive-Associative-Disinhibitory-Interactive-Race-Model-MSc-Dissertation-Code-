...
SET_1 = Final_SwitchPicData_repeat(Final_SwitchPicData_repeat.set == 'fruit_size',:);
...
SET_1Incorr = repeatDataIncorr(repeatDataIncorr.set == 'fruit_size',:);
...
condition =  repmat({'switch','switch','switch','switch',...
                     'switch','switch','switch','switch'},1,29)';
 
set = repmat({'fruit_set','fruit_set','fruit_set','fruit_set',...
              'fruit_set','fruit_set','fruit_set','fruit_set'},1,29)';

task = repmat({'fruit','fruit','fruit','fruit',...
              'fruit','fruit','fruit','fruit',},1,29)';

stimuli = repmat({'pictorial','pictorial','pictorial','pictorial',...
                  'pictorial','pictorial','pictorial','pictorial',},1,29)';
